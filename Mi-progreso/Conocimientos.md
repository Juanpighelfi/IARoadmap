...
| JavaScript aplicado | validación de entradas y límites | en aprendizaje | En la primera implementación de `cabeTurno` expresó correctamente la intención general, pero encadenó comparaciones como en matemática (`a <= b <= c`) y aceptó duración `0`; falta fijar comparaciones separadas con `&&` y contratos de validación exactos. | 2026-09-10 |
