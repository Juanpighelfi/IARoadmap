...
| JavaScript | tipos | en aprendizaje | Comprende que el tipo pertenece al valor y distingue `null` de `"null"`; reconoce `undefined`, pero todavía predijo `typeof null` como `null` en lugar de la rareza histórica `"object"`. | 2026-09-10 |
