...
| TypeScript | arrays tipados | en aprendizaje | Identificó correctamente que en un `Turno[]` cada elemento debe cumplir el tipo `Turno` y detectó un error donde `inicio` era `string` en vez de `number`; falta escribir y usar un array tipado completo. | 2026-09-12 |
