...
| JavaScript | condicionales | pendiente | Predijo correctamente `if/else`, condiciones compuestas con `&&`/`||` y una cadena `if / else if / else`; falta todavía encontrar un caso límite que rompa su modelo. | 2026-09-10 |
