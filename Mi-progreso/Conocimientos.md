...
| JavaScript | funciones | demostrado | Distingue parámetros de argumentos y comprende que `return` devuelve un valor y termina la ejecución de la función; calculó correctamente ramas con distintos `return`. | 2026-09-10 |
| JavaScript | arrays | en aprendizaje | Ya comprende que asignar un array u objeto a otra variable no crea una copia independiente sino una referencia compartida; falta consolidarlo específicamente con arrays. | 2026-09-10 |
| JavaScript | objetos | en aprendizaje | Accede y modifica propiedades con punto, pero creyó que `producto[propiedad]` daba error; falta fijar acceso por corchetes y propiedades dinámicas. | 2026-09-10 |
