...
| JavaScript aplicado | validación de entradas y límites | en aprendizaje | Corrigió en código propio la comparación encadenada `a <= b <= c` por comparaciones separadas con `&&` y cambió la duración a `> 0`; falta validar tipos, rango 0–1440 y que la franja tenga inicio menor que fin. | 2026-09-10 |
