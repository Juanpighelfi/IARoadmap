...
| JavaScript | objetos | en aprendizaje | Comprende que `obj[propiedad]` evalúa la variable para obtener el nombre de la propiedad, pero todavía creyó que acceder con punto a una propiedad inexistente (`obj.campo`) arroja error en lugar de devolver `undefined`. | 2026-09-10 |
