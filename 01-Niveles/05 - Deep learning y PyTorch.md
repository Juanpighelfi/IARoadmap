...
Puedes entrenar, guardar, evaluar y servir un modelo PyTorch simple, y explicar por que falla.
...
- **Módulo 1: Redes Neuronales Profundas con PyTorch**
  - [Prácticas del Módulo 1](practicas/modulo_1/)
- **Módulo 2: Visión Computacional**
  - [Prácticas del Módulo 2](practicas/modulo_2/)
