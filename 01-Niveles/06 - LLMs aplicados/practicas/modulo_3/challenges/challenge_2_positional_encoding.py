...
HINTS: Si te trabás, consultá modulo_3/hints/hint_challenge_2.md
=============================================================================
"""
import torch
...
# --- TODO: Implementa Positional Encoding sinusoidal ---
def positional_encoding(max_len, d_model):
    ...
    Pasos:
    1. Crea una matriz de zeros (max_len, d_model)
    2. Crea el vector de posiciones: pos = arange(0, max_len)
    3. Calcula div_term = exp(arange(0, d_model, 2) * -(log(10000) / d_model))
    4. PE[:, 0::2] = sin(pos * div_term)   ← dimensiones pares
    5. PE[:, 1::2] = cos(pos * div_term)   ← dimensiones impares
    """
...
# --- Sin PE, el orden se pierde ---
print(f"\n{'='*60}")
print("--- Sin PE: el orden se pierde ---")
print("=" * 60)

"""
TODO: Demuestra que sin PE, self-attention es permutation equivariant.
1. Crea tokens "ABC" y una versión permutada "CAB"
2. Calcula attention scores para ambos
3. Observa que las relaciones entre tokens son iguales (solo cambia el orden)
"""
...
# TODO: Calcula attention scores para ambos
