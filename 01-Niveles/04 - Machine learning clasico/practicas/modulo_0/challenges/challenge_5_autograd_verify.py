...
HINTS: Si te trabás, consultá modulo_0/hints/hint_challenge_5.md
=============================================================================
"""
...
TODO: 
  1. Crea los tensores con los mismos valores del Challenge 4
  2. Haz el forward pass con PyTorch
  3. Llama .backward() para calcular gradientes
  4. Compara W_t.grad y b_t.grad con tus gradientes manuales
"""

print("\n--- PARTE 1: Reproducir el Challenge 4 con PyTorch ---")

# TODO: Crear tensores (mismos valores que Challenge 4)
x_t = torch.tensor([1.0, 2.0])                    # input
W_t = ...  # Tu código aquí — shape [[0.5, -0.3]], requires_grad=True
b_t = ...  # Tu código aquí — [0.1], requires_grad=True
y_true_t = torch.tensor([0.8])                      # target

# TODO: Forward pass con PyTorch
z_t = ...  # W_t @ x_t + b_t
...
# TODO: Backward pass (una sola línea!)
# loss_t.backward()
...
Pasos:
  ...
  2. Calcula f
  3. Llama f.backward()
  4. Compara x.grad y y.grad con los valores analíticos
"""
...
TODO: Calcula f''(2) para f(x) = x³ + 2x
  f'(x) = 3x² + 2  → f'(2) = 14
  f''(x) = 6x       → f''(2) = 12
"""
...
# TODO: Primera derivada — mantener el grafo para segunda derivada
# grad1 = torch.autograd.grad(f3, x3, create_graph=True)[0]
grad1 = ...  # Tu código aquí

# TODO: Segunda derivada
# grad2 = torch.autograd.grad(grad1, x3)[0]
grad2 = ...  # Tu código aquí
...
# TODO: CASO 4: Acumulación de gradientes (¡el bug más común!)
# Ejecutá este loop y observá qué pasa con el gradiente:
