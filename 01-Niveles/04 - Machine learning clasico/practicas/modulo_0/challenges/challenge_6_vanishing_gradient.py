...
HINTS: Si te trabás, consultá modulo_0/hints/hint_challenge_6.md
=============================================================================
"""
...
# =============================================================================
"""
TODO: Implementa las funciones para apilar N sigmoids y calcular el gradiente.
...
def forward_stacked_sigmoids(x, n_layers):
    ...
    1. Empezá con z = x
    2. En cada capa, aplica sigmoid: z = sigmoid(z)
    3. Guardá cada activación en una lista
    """
    activations = [x]
    z = x
    # TODO: Tu loop aquí
...
def gradient_stacked_sigmoids(activations):
    ...
    TODO: Implementa el cálculo del gradiente
    1. Empezá con grad = 1.0
    2. Para cada activación (excepto la primera), calcula la derivada local
    3. Multiplica grad *= local_grad
...
# TODO: Para cada valor de n, crea un tensor, apila n sigmoids, y calcula el gradiente
for n in [1, 5, 10, 20, 50]:
    x_t = torch.tensor([0.5], requires_grad=True)
    z_t = x_t
    # TODO: Apila n sigmoids
    for _ in range(n):
        pass  # Tu código aquí: z_t = torch.sigmoid(z_t)
    z_t.backward()
...
# =============================================================================
"""
TODO: Repite el experimento con ReLU y Tanh usando PyTorch.
...
# TODO: Calcula gradientes para cada activación
grads_sigmoid = []
grads_tanh = []
grads_relu = []
...
# =============================================================================
"""
TODO: Crea dos redes profundas y mide los gradientes en cada capa:
...
def build_deep_net(activation, n_layers=15, hidden_dim=64, init='default'):
    """TODO: Construye una red profunda con la activación especificada."""
    layers = []
...
# TODO: Crea ambas redes y mide gradientes
