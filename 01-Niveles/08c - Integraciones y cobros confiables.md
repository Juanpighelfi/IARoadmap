...
[Abrir la hoja de ejercicios 08c, lista para completar](../08-Ejercicios/08c.md). Resolvé ahí el diagnóstico, la práctica y las variantes. Si hay código o laboratorio, la hoja indica qué probar y dónde anotar el resultado.
